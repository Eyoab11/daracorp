          ...
          <div className="relative" ref={langMenuRef}>
            ...
            {langOpen && (
              <ul className="absolute right-0 mt-2 w-36 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg" role="listbox">
                <li>
                  <button className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 ${lang==='en'?'text-blue-600 font-semibold':''}`} onClick={() => { setLang?.('en'); setLangOpen(false); }}>
                    English
                  </button>
                </li>
                <li>
                  <button className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 ${lang==='am'?'text-blue-600 font-semibold':''}`} onClick={() => { setLang?.('am'); setLangOpen(false); }}>
                    አማርኛ
                  </button>
                </li>
              </ul>
            ...
            <div className="px-4 py-2">
              ...
              <div className="flex items-center justify-between gap-3 px-1 py-2">
                ...
                <div className="inline-flex rounded-full border border-gray-300 bg-white p-1">
                  <button
                    className={`px-3 py-1.5 text-sm rounded-full ${lang==='en' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-50'}`}
                    onClick={() => { setLang?.('en'); }}
                  >
                    EN
                  </button>
                  <button
                    className={`px-3 py-1.5 text-sm rounded-full ${lang==='am' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-50'}`}
                    onClick={() => { setLang?.('am'); }}
                  >
                    አማ
                  </button>
